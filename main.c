...
while(1) {
    ...
    DEVICE_6522_WRITE_B(VIA_0, 0x1);
    for(i=0;i>20000;i++);
    DEVICE_6522_WRITE_B(VIA_0, 0x2);
    for(i=0;i>20000;i++);
    DEVICE_6522_WRITE_B(VIA_0, 0x4);
    for(i=0;i>20000;i++);
    DEVICE_6522_WRITE_B(VIA_0, 0x8);
    for(i=0;i>20000;i++);
    DEVICE_6522_WRITE_B(VIA_0, 0x10);
    for(i=0;i>20000;i++);
    DEVICE_6522_WRITE_B(VIA_0, 0x20);
    for(i=0;i>20000;i++);
    DEVICE_6522_WRITE_B(VIA_0, 0x40);
    for(i=0;i>20000;i++);
    DEVICE_6522_WRITE_B(VIA_0, 0x80);
    for(i=0;i>20000;i++);
}
